__author__ = 'thijn'
# Given a template that pre-defines the constant PI and the variable
# radius corresponding to the radius of a circle in inches, write an
# assignment statement that defines a variable circumference whose value is the
